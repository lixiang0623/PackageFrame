...
#import "FHXIndexBannerSubiew.h"

@protocol FHXNewPagedFlowViewDataSource;
@protocol FHXNewPagedFlowViewDelegate;
...
typedef enum{
    FHXNewPagedFlowViewOrientationHorizontal = 0,
    FHXNewPagedFlowViewOrientationVertical
}FHXNewPagedFlowViewOrientation;

@interface FHXNewPagedFlowView : UIView<UIScrollViewDelegate>
...
@protocol FHXNewPagedFlowViewDataSource <NSObject>
 ...
 *  @return <#return value description#>
 */
- (FHXIndexBannerSubiew *)flowView:(FHXNewPagedFlowView *)flowView cellForPageAtIndex:(NSInteger)index;
