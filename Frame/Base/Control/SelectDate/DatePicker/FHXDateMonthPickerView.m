...
@interface FHXDateMonthPickerView()<UIPickerViewDelegate,UIPickerViewDataSource>
//选中年
...
-(NSString *)dateStringWithformatter:(NSString *)formatter{
    return [self dateStringWithYear:self.year month:self.month formatter:formatter];
}

-(NSString *)dateStringWithYear:(NSInteger)year month:(NSInteger)month formatter:(NSString *)formatter{
